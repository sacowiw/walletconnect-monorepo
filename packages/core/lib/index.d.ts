import { ICryptoLib, ISessionStorage, ISessionStatus, ISessionError, IJsonRpcResponseSuccess, IJsonRpcResponseError, IJsonRpcRequest, ITxData, IClientMeta, IWalletConnectOptions } from '@walletconnect/types';
declare class Connector {
    ...
    private _connected;
    private _storage;
    constructor(cryptoLib: ICryptoLib, opts: IWalletConnectOptions, storage?: ISessionStorage | null, clientMeta?: IClientMeta | null);
    bridge: string;
    key: string;
    nextKey: string;
    clientId: string;
    ...
    private _sendSessionRequest;
    private _sendCallRequest;
